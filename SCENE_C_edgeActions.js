...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_dust_icon2}", "click", function(sym, e) {
         sym.play('in');
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_H_FacePull1}", "click", function(sym, e) {
         sym.play(0);
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_H_Facepull}", "click", function(sym, e) {
         sym.play('start');
